...
\begin{center}
    \WithPalette{IceLake}{\DefaultBox{#1}{#2}{\CurrentPalette{} palette}}
    \WithPalette{\rndPalette}{\DefaultBox{#1}{#2}{\CurrentPalette{} palette (random)}}
    \WithPalette{GrayPrint}{\DefaultBox{#1}{#2}{\CurrentPalette{} palette}}
\end{center}
